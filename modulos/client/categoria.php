    ...
    if ($pgn->imagem == NULL):
        ...
        <nav> 
            <div class="nav-wrapper blue">
                <div class="col s12">
                    <a href="<?= BaseHost . URL::getURL(0) ?>" class="breadcrumb"><?= $pgn->nome ?></a>
                    <a href="<?= BaseHost . URL::getURL(0) . '/' . URL::getURL(1) ?>" class="breadcrumb"><?= URL::getURL(1) ?></a>
                </div>
        </nav>
...
<div class="row">
    ...
    $listar = listar('conteudo', "WHERE status='1' and categoria_url='" . URL::getURL(1) . "' ORDER BY id DESC LIMIT $pageReturn[1], $pageReturn[2]");
...
<ul class="pagination">
    ...
    $listar = listar('conteudo', "WHERE status='1' and categoria_url='" . URL::getURL(1) . "'");
